    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            Create <br />
            <span className="bg-gradient-to-r from-teal-400 to-sky-400 text-transparent bg-clip-text">videos </span>
            from <br />
            <span className="bg-gradient-to-r from-teal-400 to-sky-400 text-transparent bg-clip-text">pdfs</span>
          ...
          <motion.div
            ...
            className="flex flex-row justify-left z-20 mx-0 mb-0 mt-8 md:mt-0 md:mb-[35px] max-w-2xl md:space-x-8"
          >
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Create and customize your own video from a PDF in minutes.
              </p>
            </div>
          </motion.div>
        ...
        <div className="h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row items-center justify-evenly">
          <p className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap   ">
            Demo made by Maria Lovin, Anjali Ramesh, Andreea Bacalum, Matthew Murphy, and Shaun Lin
          </p>
